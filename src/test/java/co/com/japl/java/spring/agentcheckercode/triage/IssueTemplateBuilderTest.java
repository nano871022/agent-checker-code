...
class IssueTemplateBuilderTest {
    ...
    void testBuildCrashIssueRequest_FullData() {
        StackFrame frame = StackFrame.builder()
                .packageName("co.com.japl.java.spring.agentcheckercode")
                .className("co.com.japl.java.spring.agentcheckercode.triage.TriageService")
        ...
        CrashEvent crashEvent = CrashEvent.builder()
                ...
                .stackTrace("java.lang.NullPointerException: Object reference is null\n\tat co.com.japl.java.spring.agentcheckercode.triage.TriageService.triageCrashEvent(TriageService.java:42)")
                .eventCount(15)
        ...
        assertTrue(body.contains("- **Class:** co.com.japl.java.spring.agentcheckercode.triage.TriageService"));
