...
class IssueTemplateBuilderTest {
    ...
    void testBuildCrashIssueRequest_FullData() {
        StackFrame frame = StackFrame.builder()
                .packageName("co.dev.japl.java.spring.agentcheckercode")
                .className("co.dev.japl.java.spring.agentcheckercode.triage.TriageService")
        ...
        CrashEvent crashEvent = CrashEvent.builder()
                ...
                .stackTrace("java.lang.NullPointerException: Object reference is null\n\tat co.dev.japl.java.spring.agentcheckercode.triage.TriageService.triageCrashEvent(TriageService.java:42)")
                .eventCount(15)
        ...
        assertTrue(body.contains("- **Class:** co.dev.japl.java.spring.agentcheckercode.triage.TriageService"));
